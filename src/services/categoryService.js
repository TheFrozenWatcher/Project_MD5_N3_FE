...
import {
    ...
    createCategory,
    updateCategory,
} from "../../services/categoryService"; // Corrected import path to services
...
export default function AdminCategoryIndex() {
    ...
    const handleUpdateCategory = (categoryData) => {
        dispatch(updateCategory({ categoryId: idToUpdate, category: categoryData }));
            ...
            {showForm && (
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-white rounded-lg p-6 w-3/4 max-w-lg shadow-lg relative">
                        ...
                        <NewCategoryForm onSubmit={handleCreateCategory} onClose={toggleForm} />
                    </div>
                </div>
            )}
